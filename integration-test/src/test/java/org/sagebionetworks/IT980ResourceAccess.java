...
public class IT980ResourceAccess {
	...
	public void testCreateResourceAccess() throws Exception {
		...
		synapse.createJSONObjectEntity(authEndpoint, "/resourceAccess/"+RESOURCE_NAME, obj, null);
	...
	public void testCreateAndGetResourceSession() throws Exception {
		...
		JSONObject session = synapse.createJSONObjectEntity(authEndpoint, "/resourceSession/"+RESOURCE_NAME, empty, null);
